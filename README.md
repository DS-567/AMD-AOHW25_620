...
❕ Note, as described in the report there are 2 different hardware implementations of the SNN. The Fast SNN source code can be found in the [Demonstrator/hw/Vivado](/Demonstrator/hw/Vivado) and the SNN (time-mux) can be found in the [Reference_SNN_HDL folder](/Reference_SNN_HDL).
...
- **IEEE ISCAS 2025 live demonstrator conference paper:** [![](https://img.shields.io/badge/IEEE-Demo-blue)](https://ieeexplore.ieee.org/document/11044164)
...
- **IEEE TCAS II: Express Briefs invited journal paper:** [![](https://img.shields.io/badge/IEEE-Paper-blue)](https://ieeexplore.ieee.org/document/11051055)
