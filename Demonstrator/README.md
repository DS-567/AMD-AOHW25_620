...
It features:
- A physical hardare setup (left) i.e motor, encoder, custom PCBs, FPGA.
...
- PI-speed control C algorithm is compiled and executed on Neorv32, resembling a safety-critical motor control task.
