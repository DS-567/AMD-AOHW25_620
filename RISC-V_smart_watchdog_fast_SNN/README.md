...
**Note:** The Fibonacci Series C and disassembled source code can be found: [neorv32-main/sw/examples/my_code_fibonacci_series](/RISC-V_smart_watchdog_fast_SNN/neorv32-main/sw/example/my_code_fibonacci_series/main.asm)
...
**Step 5** - Arm the ILA core by pressing `>`. Press the bottom button on the FPGA board to initiate the smart watchdog and trigger the ILA core:
...
<p align="center">
  <img src="../assets/IL_spikes_SNNTorch.PNG" alt="IL Spikes SNNTorch" width="800"/>
</p>

<p align="center">
  <img src="../assets/IL_spikes_fpga.PNG" alt="IL Spikes FPGA" width="800"/>
</p>
...
<p align="center">
  <img src="../assets/HL_spikes_SNNTorch.PNG" alt="HL Spikes SNNTorch" width="800"/>
</p>

<p align="center">
  <img src="../assets/HL_spikes_fpga.PNG" alt="HL Spikes FPGA" width="800"/>
</p>
...
<p align="center">
  <img src="../assets/OL_spikes_SNNTorch.PNG" alt="OL Spikes SNNTorch" width="800"/>
</p>

<p align="center">
  <img src="../assets/OL_spikes_fpga.PNG" alt="OL Spikes FPGA" width="800"/>
</p>
...
The MSB (bit 7) of the DIP switch on the AMD VC709 FPGA board is used to enable fault injection. The setup register for bit 4 fault one is hard-coded as a bit flip during the first instruction. Activating the switch should show the smart watchdog detecting the transient fault.
